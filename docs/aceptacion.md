...
- H13: HTML inferior a 40 KB y logo externo con dimensiones declaradas. Tras recibir el archivo del cliente, se sustituyó la versión procesada por su JPEG original sin alteraciones (1088 × 976, 139.026 bytes; identidad comprobada por SHA-256). Se usa en cabecera, pie, favicon, Open Graph y Organization. Conserva el fondo blanco del archivo entregado; queda pendiente una versión oficial transparente y optimizada para cumplir el objetivo inicial de menos de 6 KB. No se conserva el logo recreado con ImageGen.
